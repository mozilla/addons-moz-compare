(function addonsMozCompare() {
  ...
  const parseVersionPart = (versionPart) => {
    ...
    // or the sign that introduces it. See:
    // https://searchfox.org/firefox-main/rev/61c7b6d2fe5fc598e573df6528447ab48bc027b3/xpcom/base/nsVersionComparator.cpp#111
    const numberCStart = /[\d+-]/.exec(rest);
